...
DROP POLICY IF EXISTS "Teacher view course_enrollments" ON public.course_enrollments;
...
DROP POLICY IF EXISTS "Student view own course_enrollments" ON public.course_enrollments;
